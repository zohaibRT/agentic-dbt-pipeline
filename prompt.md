...
The presentation-layer recommendation is required for full pipeline final delivery. If you cannot produce it, mark it blocked or skipped with the reason in the final report, pipeline status, context tree, and final response.
