...
|---|---|
| Discovery | Project-oriented source/schema analysis, source conclusions, data quality notes, candidate models/metrics, and requirements checkpoint before build planning |
