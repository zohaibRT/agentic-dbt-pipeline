...
- Target **50+** supported rows in `measure_catalog.md` and **30+** in `metric_catalog.md` when gold evidence allows; do not stop at three to five executive KPIs. Read [reporting-coverage-requirements.md](references/reporting-coverage-requirements.md).
