...
| **8b Presentation layer** | Optional final user-facing layer after analytics insight reporting | [presentation-layer.md](references/presentation-layer.md), [powerbi-template.md](references/powerbi-template.md), [powerbi-pbip-desktop-requirements.md](references/powerbi-pbip-desktop-requirements.md) when Power BI is approved |
