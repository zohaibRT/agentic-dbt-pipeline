...
Source objects: <measure, metric, key performance indicator, mart, or semantic metric>
Expected result: <expected numerator, denominator, metric value, variance, or reconciliation result>
Captured result at run time:
<small aggregate result table copied from command output>
Status: PASS | WARN | FAIL | BLOCKED | SKIPPED
Re-run notes: <profile/target/schema assumptions and safe filters>
