...
- Matplotlib presentation status when used as the default or requested presentation technology, including prerequisite install status, `kpi_figure_coverage.md` completeness, local web report server smoke test, chart refresh behavior, SQL verification, and blocked visuals
...
- Presentation artifact type: Matplotlib refreshable web report, Power BI PBIP/TMDL project, dashboard design guide, presentation report, or query handoff
