...
| `presentation_layer` | [presentation-layer.md](presentation-layer.md), [matplotlib-presentation-layer.md](matplotlib-presentation-layer.md), [universal-analytics-framework.md](universal-analytics-framework.md), [reporting-standards.md](reporting-standards.md) |
