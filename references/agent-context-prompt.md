...
- After each completed or blocked checkpoint: write/update reports/agent/NEXT_PHASE_PROMPT.md, show the exact prompt for the recommended next phase, ask through a native interactive question when available, and accept approval only for that displayed prompt
