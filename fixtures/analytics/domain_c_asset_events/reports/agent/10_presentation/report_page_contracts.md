...
|---|---|---|---|---|---|---|---|---|
| Executive Overview | leadership | Summarize Asset event monitoring | Prioritize interventions | Volume KPI, Completion rate KPI | Current month | Open exceptions listed | Act on failure spike | PASS |
