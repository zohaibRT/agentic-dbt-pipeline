...
|---|---|---|---|---|---|---|---|---|
| Executive Overview | leadership | Summarize Case activity lifecycle | Prioritize interventions | Volume KPI, Completion rate KPI | Current month | Open exceptions listed | Act on failure spike | PASS |
