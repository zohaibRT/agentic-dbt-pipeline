...
|---|---|---|---|---|---|---|---|---|---|
| DISC-001 | Model Case activity lifecycle from seeds | reports/agent/00_discovery/requirements.md | Case activity lifecycle | bronze | models/staging/stg_case_activities.sql | reports/agent/03_bronze/sql_proofs/010_row_count.sql | reports/agent/10_presentation/matplotlib/report.html | PASS | Fixture |
