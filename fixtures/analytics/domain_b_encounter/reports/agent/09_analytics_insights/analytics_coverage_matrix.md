...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| Encounter lifecycle | fct_encounters | dim_providers, dim_locations, dim_statuses | yes | 6 | 4 | 2 | current+prior | yes | yes | yes | yes | Executive Overview | owner | PASS | none |
