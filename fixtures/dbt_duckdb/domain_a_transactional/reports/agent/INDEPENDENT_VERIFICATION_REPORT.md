...
**Overall status:** PASS
**Checked at:** 2026-07-16T13:53:45.198547+00:00
**Project root:** `C:\codebase\agentic-dbt-pipeline\fixtures\dbt_duckdb\domain_a_transactional`
**Mode:** `independent`
...
| Check | Status | Detail |
|---|---|---|
| manifest_inventory | PASS | resources=26 |
