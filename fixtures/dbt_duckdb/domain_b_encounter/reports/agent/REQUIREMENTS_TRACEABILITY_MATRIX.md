...
|---|---|---|---|---|---|---|---|---|---|
| DISC-001 | Model Encounter lifecycle from seeds | reports/agent/00_discovery/requirements.md | Encounter lifecycle | bronze | models/staging/stg_statuses.sql | reports/agent/03_bronze/sql_proofs/010_row_count.sql | reports/agent/10_presentation/matplotlib/report.html | PASS | Fixture |
